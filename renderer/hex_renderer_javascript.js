...
* @returns {Uint8Array}
*/
export function draw_hex_grid(grid_options, patterns, max_width, scale) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(patterns, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.draw_hex_grid(retptr, addHeapObject(grid_options), ptr0, len0, max_width, scale);
...
* @returns {Uint8Array}
*/
export function draw_bound_hex_grid(grid_options, patterns, max_width, width, height) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(patterns, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.draw_bound_hex_grid(retptr, addHeapObject(grid_options), ptr0, len0, max_width, width, height);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
* @returns {Uint8Array}
*/
export function draw_square_grid(grid_options, patterns, max_width, max_scale, x_pad, y_pad, scale) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(patterns, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.draw_square_grid(retptr, addHeapObject(grid_options), ptr0, len0, max_width, max_scale, x_pad, y_pad, scale);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
* @returns {Uint8Array}
*/
export function draw_bound_square_grid(grid_options, patterns, max_width, max_scale, x_pad, y_pad, width, height) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(patterns, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.draw_bound_square_grid(retptr, addHeapObject(grid_options), ptr0, len0, max_width, max_scale, x_pad, y_pad, width, height);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('hex_renderer_javascript_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
